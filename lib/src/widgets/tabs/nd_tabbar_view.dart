...
class NDTabBarView extends StatefulWidget {
  const NDTabBarView({
    Key? key,
  ...
  @override
  _NDTabBarViewState createState() => _NDTabBarViewState();
}

class _NDTabBarViewState extends State<NDTabBarView> {
  ...
  @override
  void didUpdateWidget(NDTabBarView oldWidget) {
