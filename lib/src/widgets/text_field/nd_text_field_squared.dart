...
import 'nd_text_field.dart';

class NDTextFieldSquared extends StatefulWidget {
  const NDTextFieldSquared(
      {Key? key,
  ...
  @override
  _NDTextFieldSquaredState createState() => _NDTextFieldSquaredState();
}

class _NDTextFieldSquaredState extends State<NDTextFieldSquared> {
  @override
