...
class NDTextFieldPill extends StatefulWidget {
  const NDTextFieldPill(
      {Key? key,
  ...
  @override
  _NDTextFieldPillState createState() => _NDTextFieldPillState();
}

class _NDTextFieldPillState extends State<NDTextFieldPill> {
  @override
