...
class NDTextFieldRounded extends StatefulWidget {
  const NDTextFieldRounded(
      {Key? key,
  ...
  @override
  _NDTextFieldRoundedState createState() => _NDTextFieldRoundedState();
}

class _NDTextFieldRoundedState extends State<NDTextFieldRounded> {
  @override
