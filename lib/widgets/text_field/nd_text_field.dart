...
class NDTextField extends FormField<String> {
  NDTextField(
      {Key? key,
      this.controller,
      ...
      : super(
            key: key,
            builder: (FormFieldState<String> field) => _NDTextFieldState(
                  state: field,
...
class _NDTextFieldState extends StatefulWidget {
  const _NDTextFieldState(
      {required this.state,
      this.controller,
      this.initialValuex = '',
      this.focusNode,
  ...
  @override
  State<_NDTextFieldState> createState() => _NDTextFieldStateState();
}

class _NDTextFieldStateState extends State<_NDTextFieldState>
