...
import 'providers/nd_datepickerprovider.dart';

class NDDatePicker extends StatefulWidget {
  NDDatePicker(
      {Key? key,
      this.errorText,
      this.cancelText,
  ...
  @override
  State<NDDatePicker> createState() => _NDDatePickerState();
...
class _NDDatePickerState extends State<NDDatePicker> {
  late final NDFormHandler ndFormHandler;
  DateTime selectedDate = DateTime.now();
  late final NDDatePickerData dataModel;

  @override
  void initState() {
    selectedDate = widget.defaultDate ?? DateTime.now();
    dataModel = NDDatePickerData(selectedDate: selectedDate);
    super.initState();
  }
