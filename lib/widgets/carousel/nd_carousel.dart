...
class NDCarousel extends StatefulWidget {
  const NDCarousel({
    Key? key,
    required this.items,
    this.pagerSize,
  ...
  @override
  _NDCarouselState createState() => _NDCarouselState();
}

class _NDCarouselState extends State<NDCarousel> with TickerProviderStateMixin {
  Timer? timer;
